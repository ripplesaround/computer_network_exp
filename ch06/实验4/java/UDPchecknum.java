public class UDPchecknum {
    static String udpsegment = "d9622712000b25ed777364";
    ...
    public static void main(String[] args){
        ...
        pseudo_head += "00";
        System.out.println("Transport layer protocol: " + intToBinary(17,8));
        pseudo_head += String.format("%02X",17);
        System.out.println("UDP Length: " + intToBinary(udpsegment.length()/2,16));
        pseudo_head += String.format("%04X",udpsegment.length()/2);
        udpsegment =  udpsegment.substring(0,12)+"0000"+udpsegment.substring(16,udpsegment.length());
        String checkstr = (pseudo_head + udpsegment).toUpperCase();
